...
var updateYandex = function (store, sendMessage) { return __awaiter(void 0, void 0, void 0, function () {
    var dates, products, customerOrders, campaigns, campaignIds, fbsOrders, fbyOrders, fbsNewOrders, fbyNewOrders, _a, fbsOrdersWithNewData, fbsFilteredOrders, _b, fbyOrdersWithNewData, fbyFilteredOrders, fby, fbs, domain, returns, pickedReturns_1, fbsWithPicked, preparedCustomerOrders, err_1;
    var _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
            ...
            case 8:
                ...
                pickedReturns_1 = returns === null || returns === void 0 ? void 0 : returns.filter(function (r) { return r.shipmentStatus === 'PICKED'; });
                fbsWithPicked = fbs.reduce(function (acc, cur) {
                    pickedReturns_1 === null || pickedReturns_1 === void 0 ? void 0 : pickedReturns_1.forEach(function (item) {
                        if (item.orderId === cur.id) {
                            acc.push(__assign(__assign({}, cur), { status: marketTypes_1.OrderStatusEnum.PICKED_REFUND }));
                        }
                    });
                    acc.push(__assign({}, cur));
                    return acc;
                }, []);
                logger_1.default.info(fbs.length);
                logger_1.default.info(fbsWithPicked.length);
