    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                dates = {
                    dateFrom: (0, dayjs_1.default)().subtract(4, 'month').format('YYYY-MM-DD'),
                    dateTo: (0, dayjs_1.default)().add(1, 'month').format('YYYY-MM-DD'),
                };
                filter = {
                    since: (0, dayjs_1.default)().subtract(4, 'month').toISOString(),
                    to: (0, dayjs_1.default)().add(1, 'month').toISOString(),
                };
                ordersProps = {
                    dir: 'ASC',
                    filter: filter,
            ...
            case 6:
                fbsReturns_1 = (_a.sent());
                logger_1.default.info("[".concat(store, "]: \u041F\u043E\u043B\u0443\u0447\u0435\u043D\u044B \u0434\u0430\u043D\u043D\u044B\u0435 \u043F\u043E \u0432\u043E\u0437\u0432\u0440\u0430\u0442\u0430\u043C \u043C\u0430\u0433\u0430\u0437\u0438\u043D\u0430..."));
                articlesFromMS = products.rows.map(function (row) { return row.article; });
            ...
            case 7:
                prices = (_a.sent());
                fboAfterReturns_1 = fboOrders.result.reduce(function (acc, cur) {
                    fboReturns_1.returns.forEach(function (item) {
                ...
                fbsAfterReturns_1 = fbsOrders.result.postings.reduce(function (acc, cur) {
                    fbsReturns_1.returns.forEach(function (item) {
                        if (item.posting_number === cur.posting_number) {
                ...
                filteredFboOrders = fboOrders.result.filter(function (order) {
                    return fboAfterReturns_1.every(function (fbo) { return fbo.posting_number !== order.posting_number; });
                });
                filteredFbsOrders = fbsOrders.result.postings.filter(function (order) {
                    return fbsAfterReturns_1.every(function (fbs) { return fbs.posting_number !== order.posting_number; });
                });
                preparedCustomerOrders_1 = (0, prepareOzonCustomerOrder_1.prepareOzonCustomerOrders)(products.rows, __spreadArray(__spreadArray([], filteredFboOrders, true), fboAfterReturns_1, true), __spreadArray(__spreadArray([], filteredFbsOrders, true), fbsAfterReturns_1, true).filter(function (item) { return item.posting_number !== '0145992433-0031-1'; })
                    .filter(function (item) { return item.posting_number !== '28059370-0058-6'; })
                    .filter(function (item) { return item.posting_number !== '0122683245-0020-1'; }), customerOrders.rows, prices.result.items);
            ...
            case 9:
                ...
                preparedDemands = (0, prepareDemands_1.prepareDemands)(ordersForDemands, demands.rows, 'OZON');
            ...
            case 11:
                ...
                preparedPaymentins = (0, prepareOzonPaymentin_1.prepareOzonPaymentin)(newDemands, __spreadArray(__spreadArray([], filteredFboOrders, true), fboAfterReturns_1, true), __spreadArray(__spreadArray([], filteredFbsOrders, true), fbsAfterReturns_1, true).filter(function (item) { return item.posting_number !== '0145992433-0031-1'; })
                    .filter(function (item) { return item.posting_number !== '28059370-0058-6'; })
                    .filter(function (item) { return item.posting_number !== '0122683245-0020-1'; }), paymentins.rows);
            ...
            case 13:
                ...
                preparedSalesReturn = (0, prepareSalesreturn_1.prepareSalesReturn)(newDemands, ordersForDemands, salesReturn.rows, 'OZON');
            ...
            case 15:
                ...
                preparedPaymentouts = (0, prepareOzonPaymentout_1.prepareOzonPaymentout)(newSalesReturns, __spreadArray(__spreadArray([], filteredFboOrders, true), fboAfterReturns_1, true), __spreadArray(__spreadArray([], filteredFbsOrders, true), fbsAfterReturns_1, true).filter(function (item) { return item.posting_number !== '0145992433-0031-1'; })
                    .filter(function (item) { return item.posting_number !== '28059370-0058-6'; })
                    .filter(function (item) { return item.posting_number !== '0122683245-0020-1'; }), paymentouts.rows);
