...
exports.getProductPrices = void 0;
var axios_1 = __importDefault(require("axios"));
var service_1 = require("./service");
var logger_1 = __importDefault(require("../../lib/logger"));
var getProductPrices = function (_a) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                return [4 /*yield*/, service_1.apiService.post('v4/product/info/prices', __assign({}, props))];
            case 1:
                response = _b.sent();
