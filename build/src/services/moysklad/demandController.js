...
var createDemand = function (demands) {
	return __awaiter(void 0, void 0, void 0, function () {
		...
		return __generator(this, function (_a) {
			switch (_a.label) {
				case 0:
					...
					return [
						4 /*yield*/,
						service_1.apiService.post('entity/demand', demands),
					]
				case 1:
					response = _a.sent()
