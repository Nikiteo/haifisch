...
var getPaymentin = function (dates) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                getPaymentin_1 = function (offset) { return __awaiter(void 0, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_c) {
                        switch (_c.label) {
                            ...
                            case 1:
                                ...
                                return [4 /*yield*/, getPaymentin_1(1000)];
                            case 2: return [2 /*return*/, _b.apply(_a, [_c.sent()])];
                            case 3: return [2 /*return*/, paymentins];
                        }
                    });
                }); };
...
var createPaymentin = function (paymentins) { return __awaiter(void 0, void 0, void 0, function () {
    var response, error_2, err;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, service_1.apiService.post('entity/paymentin', paymentins)];
            case 1:
                response = _a.sent();
