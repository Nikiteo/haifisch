...
exports.createCashout = void 0;
var axios_1 = __importDefault(require("axios"));
var service_1 = require("./service");
var logger_1 = __importDefault(require("../../lib/logger"));
var createCashout = function (cashouts) { return __awaiter(void 0, void 0, void 0, function () {
    var response, error_1, err;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, service_1.apiService.post('entity/cashout', cashouts)];
            case 1:
                response = _a.sent();
