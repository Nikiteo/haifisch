export const hfSupplier = {
	meta: {
		...
		uuidHref:
			'https://online.moysklad.ru/app/#mycompany/edit?id=4f9c637b-f557-11ed-0a80-11cd001da709',
	},
}

export const topSupplier = {
	meta: {
		...
		mediaType: 'application/json',
		uuidHref:
			'https://online.moysklad.ru/app/#mycompany/edit?id=846d12a8-97e8-11ee-0a80-0246002f6590',
	},
}
...
export const ozonSupplier = {
	meta: {
		...
		mediaType: 'application/json',
		uuidHref:
			'https://online.moysklad.ru/app/#mycompany/edit?id=d77580ae-9991-11ee-0a80-148f0009369c',
	},
}
...
export const uom = {
	meta: {
		...
		metadataHref:
			'https://api.moysklad.ru/api/remap/1.2/entity/uom/metadata',
		type: 'uom',
		mediaType: 'application/json',
	},
}
...
export const fboOzonStore = {
	meta: {
		...
		mediaType: 'application/json',
		uuidHref:
			'https://online.moysklad.ru/app/#warehouse/edit?id=702fc37a-9037-11ee-0a80-0d6b00124713',
	},
}
...
export const fbsOzonStore = {
	meta: {
		...
		mediaType: 'application/json',
		uuidHref:
			'https://online.moysklad.ru/app/#warehouse/edit?id=73134230-9037-11ee-0a80-156300126436',
	},
}

export const fbsHfStore = {
	meta: {
		...
		mediaType: 'application/json',
		uuidHref:
			'https://online.moysklad.ru/app/#warehouse/edit?id=672b05f0-9037-11ee-0a80-112800118806',
	},
}

export const fbsTopStore = {
	meta: {
		...
		mediaType: 'application/json',
		uuidHref:
			'https://online.moysklad.ru/app/#warehouse/edit?id=6ca2cea4-9037-11ee-0a80-04c80012aa64',
	},
}

export const fbyHfStore = {
	meta: {
		...
		mediaType: 'application/json',
		uuidHref:
			'https://online.moysklad.ru/app/#warehouse/edit?id=638399f8-9037-11ee-0a80-0b7200117b2d',
	},
}

export const fbyTopStore = {
	meta: {
		...
		mediaType: 'application/json',
		uuidHref:
			'https://online.moysklad.ru/app/#warehouse/edit?id=6a22d928-9037-11ee-0a80-016c00134c2d',
	},
}
...
export const fbsHfRefund = {
	meta: {
		...
		mediaType: 'application/json',
		uuidHref:
			'https://online.moysklad.ru/app/#warehouse/edit?id=12a929db-980c-11ee-0a80-04d80038a3a3',
	},
}
export const fbyHfRefund = {
	meta: {
		...
		mediaType: 'application/json',
		uuidHref:
			'https://online.moysklad.ru/app/#warehouse/edit?id=f4a67774-9814-11ee-0a80-0397003ae2ec',
	},
}
export const fbsTopRefund = {
	meta: {
		...
		mediaType: 'application/json',
		uuidHref:
			'https://online.moysklad.ru/app/#warehouse/edit?id=fa92e400-9814-11ee-0a80-0397003ae3fe',
	},
}
export const fbyTopRefund = {
	meta: {
		...
		mediaType: 'application/json',
		uuidHref:
			'https://online.moysklad.ru/app/#warehouse/edit?id=0076ac29-9815-11ee-0a80-04d8003ae3b3',
	},
}

export const fboOzonRefund = {
	meta: {
		...
		mediaType: 'application/json',
		uuidHref:
			'https://online.moysklad.ru/app/#warehouse/edit?id=4992766c-9f08-11ee-0a80-026e0006caf9',
	},
}

export const fbsOzonRefund = {
	meta: {
		...
		mediaType: 'application/json',
		uuidHref:
			'https://online.moysklad.ru/app/#warehouse/edit?id=4ee0823d-9f08-11ee-0a80-026e0006cc11',
	},
}

export const productFolder = {
	meta: {
		...
		mediaType: 'application/json',
		uuidHref:
			'https://online.moysklad.ru/app/#good/edit?id=0fbdc67d-94c3-11ee-0a80-109f001c42ce',
	},
}
...
export const agent = {
	meta: {
		...
		mediaType: 'application/json',
		uuidHref:
			'https://online.moysklad.ru/app/#company/edit?id=2d059b74-92a6-11ee-0a80-145a0044e87e',
	},
}
...
export const fboOzonProject = {
	meta: {
		...
		mediaType: 'application/json',
		uuidHref:
			'https://online.moysklad.ru/app/#project/edit?id=000926c7-f559-11ed-0a80-071f001dbb13',
	},
}
...
export const fbyTopProject = {
	meta: {
		...
		mediaType: 'application/json',
		uuidHref:
			'https://online.moysklad.ru/app/#project/edit?id=f6c5a0f7-f558-11ed-0a80-01bd001d779e',
	},
}
...
export const consignee = {
	meta: {
		...
		mediaType: 'application/json',
		uuidHref:
			'https://online.moysklad.ru/app/#company/edit?id=500dc004-f557-11ed-0a80-11cd001da732',
	},
}
