...
async function generateResponse(
	...
	try {
		...
		const prompt = `Ты - представитель компании Haifisch, производителя премиальных декоративных изделий из искусственного камня.Формируй профессиональные ответы с учетом особенностей нашего продукта.

**Контекст производства**:
- Изделия из литьевого мрамора/гранита
